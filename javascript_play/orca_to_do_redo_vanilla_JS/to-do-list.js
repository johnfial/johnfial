...
function add_task(task_name) {
    ...
    // add datetime to the text...
    new_task_label.innerText += (`Added on ${day} / ${month} / ${year}`)
    ...
    console.log(`function add_task() ran successfully with input task_name: ${task_name} `);
};
