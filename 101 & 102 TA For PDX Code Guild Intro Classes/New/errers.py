...
while True:
    ...
    if user == computer: ### after running game, line 34 errors. 'users' is not defined. CJM
        print("Looks like a tie") ###added the ) symbol. Faulting on a later line. CJM
    ...
    # check all cases if user is paper
        ...
        # check winning case
        if computer == "rock": ### added the : symbol. The error was invalid syntax. CJM.
            print("You win!")
    ...
    # check all cases if user is scissors
        ...
        # check losing case
            ...
            print("Sorry, You lose.") ### Print is capitalized. Error was that Print was not defined. CJM