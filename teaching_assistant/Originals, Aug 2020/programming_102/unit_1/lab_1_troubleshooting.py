...
# https://github.com/PdxCodeGuild/Programming102/blob/master/labs/lab1.md
"""
...
while True:
    ...
    while user not in choices:
        user = input("Choose either 'rock', 'paper', or 'scissors'").lower() # nice modification to lowercase the user input!
    ...
    # if the user and computer are the same it is a tie
        elif user == computer: # ERROR #1 CHANGED USERS TO USER
            print("Looks like a tie") # ERROR #2 ADDED PARENTHESIS AND INDENTED
...
# indented after here
        ...
        # check all cases if user is rock
            ...
            # check losing case
            elif computer == "paper": # ERROR #3 CHANGED ROCK HERE TO PAPER
        ...
        # check all cases if user is paper
            ...
            # check winning case
            if computer == "rock": # ERROR #4 ADDED COLON
                print("You win!")
        ...
        # check all cases if user is scissors
            ...
            # check losing case
                ...
                print("Sorry, You lose.") #ERROR #5 CHANGED Print to print lowercase

    # NOTE ERROR FINALLY FIXED BY MOVING TO THE END AND UN-INDENTING ONE BIT! 
    # but why... ?
